<script lang="ts">
    ...
    let levels: Level[] = [
        // Beginner Levels
        { id: 1, title: 'Level 1', difficulty: 'beginner', isUnlocked: true },
        { id: 2, title: 'Level 2', difficulty: 'beginner', isUnlocked: false },
        // Medium Levels
        { id: 3, title: 'Level 3', difficulty: 'medium', isUnlocked: false },
        { id: 4, title: 'Level 4', difficulty: 'medium', isUnlocked: false },
        // Hard Levels
        { id: 5, title: 'Level 5', difficulty: 'hard', isUnlocked: false },
        { id: 6, title: 'Level 6', difficulty: 'hard', isUnlocked: false },
    ];
